...
function createGraph(TuringComputation){
    /*console.log("WriteSymbol: " + TuringComputation.writeSymbol);
    console.log("CurrentState: " + TuringComputation.currentState);
    console.log("ReadSymbol: " + TuringComputation.readSymbol);
    console.log("Move: " + TuringComputation.move);
    console.log("NextState: " + TuringComputation.nextState);*/
    ...
    //graph.links.push([TuringComputation.currentState,TuringComputation.nextState,newLabel]);
